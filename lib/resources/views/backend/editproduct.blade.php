							...
							<div class="row" style="margin-bottom:40px">
								<div class="col-xs-8">
									...
									<div class="form-group" >
										...
										Có: <input type="radio" name="featured" value="1" @if($product->prod_featured == 1) selected checked @endif>
										Không: <input type="radio" name="featured" value="0" @if($product->prod_featured == 0) selected checked @endif>
									</div>
